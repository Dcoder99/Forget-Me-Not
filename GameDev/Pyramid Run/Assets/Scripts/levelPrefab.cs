...
public class levelPrefab : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        level.Add(prefab1);
        prefab1 = new List<float>() { (float)prefabs.coin, (p_len2 + 1.5f * t_len), 2 * t_len, 0, 1 };
        level.Add(prefab1);
        ...
        level.Add(prefab1);
        prefab1 = new List<float>() { (float)prefabs.coin, (p_len2 + 4.5f * t_len), (-t_len), 90, 2 };
        level.Add(prefab1);
        ...
        level.Add(prefab1);
        prefab1 = new List<float>() { (float)prefabs.coin, (2 * p_len2 + 3f * t_len), (2*p_len2-p_len/2), 180, 3 };
        level.Add(prefab1);
        array.Add(level);
