...
public class controller : MonoBehaviour {
	...
	float scaleVal = 0.050f, spacing = 1f;
	...
	void GameOver()
	{
		if(PlayerPrefs.GetInt("FB_highscore", 0) < sc)
		{
			PlayerPrefs.SetInt("FB_highscore", sc);
		}
		SceneManager.LoadScene("FB_GameOverScene");
	}
