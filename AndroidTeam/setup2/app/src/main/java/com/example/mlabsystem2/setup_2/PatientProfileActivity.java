...
public class PatientProfileActivity extends AppCompatActivity {
    ...
    private TextView txt_location,txt_customize, txt_schedule,instruct; //clickables
    ...
    public void instructions() {
        Intent instructs=new Intent(this,Instructions.class);
        startActivity(instructs);
    }
