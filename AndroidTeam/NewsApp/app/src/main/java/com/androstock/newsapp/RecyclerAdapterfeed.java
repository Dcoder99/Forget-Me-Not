...
public class RecyclerAdapterfeed extends RecyclerView.Adapter<RecyclerAdapterfeed.ImageViewHolder> {
    ...
    public void onBindViewHolder(RecyclerAdapterfeed.ImageViewHolder holder, int position) {
        ...
        try{
            holder.author1.setText(song.get(MainActivity.KEY_AUTHOR));
            holder.title1.setText(song.get(MainActivity.KEY_TITLE));
            holder.time.setText(song.get(MainActivity.KEY_PUBLISHEDAT));
            holder.description.setText(song.get(MainActivity.KEY_DESCRIPTION));
